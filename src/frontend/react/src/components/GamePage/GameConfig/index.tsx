...
interface GameConfigProps {
  onJoinGame: (paddleColorIndex: number, fanIndex: number, fieldColorIndex: number) => void
}
  ...
  return (
    <div className={styles.gameConfigContainer}>
      ...
      <div className={styles.field}>
        ...
        <ColorPicker colors={paddleColors} onColorChange={(index) => setPaddleColorIndex(index)} />
      </div>
      <div className={styles.field}>
      ...
      <div className={styles.field}>
        ...
        <ColorPicker colors={fieldColors} onColorChange={(index) => setFieldColorIndex(index)} />
      </div>
      <Button
        variant="outlined"
        className={styles.joinGameButton}
        onClick={() => onJoinGame(paddleColorIndex, fanIndex, fieldColorIndex)}
      >
        Join a Game
      </Button>
    </div>
